...
output_file_path = rospkg.RosPack().get_path('ds_follow_waypoints')+"/saved_path/pose.csv"
waypoints = []
...
class GetPath(State):
    ...
    def execute(self, userdata):
        ...
        # for loading the saved poses from ds_follow_waypoints/saved_path/poses.csv
